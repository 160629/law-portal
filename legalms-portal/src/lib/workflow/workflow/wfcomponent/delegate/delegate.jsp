...
<table width="497" border="0" cellspacing="0" cellpadding="0" class="EOS_panel_body" height="100%">
  <tr>
    <td class="EOS_panel_head" valign="middle" colspan="2">设置代办任务</td>
  </tr>
  <tr>
    <td class="EOS_table_row" nowrap="nowrap" width="15%" align="left">&nbsp;&nbsp;代办人:</td>
  ...
  <tr>
    <td class="EOS_table_row" nowrap="nowrap" valign="top" width="15%" align="left">&nbsp;&nbsp;代办原因:</td>
  ...
  <tr>
    <td class="EOS_table_row" align="center" colspan="2" valign="top">
		<input type="button" id="buttonOK" value="确定" class="button"> <input type="reset" value="重置" class="button" onclick="clearP();"> <input type="button" value="取消" class="button" onclick="window.close();">
    </td>
  </tr>
</table>
</form>
