...
<table class="result" border="0" width="30%" align="center">
	<tr class="result_content_" border="0" width="30%">
		<td align="center" colspan="2"><b><b:message key="success_back_jsp.execute_result"/></b></td><%-- 执行结果: --%>
	</tr>
	<tr>
		<td></td>
	</tr>
	...
	<tr class="result_content_" border="0" width="30%">
		<td align="center" colspan="2"><b><b:message key="success_back_jsp.operation_success"/></b></td><%-- 操作成功！ --%>
	</tr>
	<tr>
		<td></td>
	</tr>
